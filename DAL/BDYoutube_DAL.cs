...
namespace DAL
{
    public class BDYoutube_DAL
    {
        ...
        public async Task<List<BDYoutube_BLL>> BuscarVideos(string query)
        {
            using (var client = new HttpClient())
            {
                string url = $"https://www.googleapis.com/youtube/v3/search?part=snippet&q={query}&key=AIzaSyBHtTQc8vZTNZZI2NUB28cTawjH9EfQioo&type=video";
